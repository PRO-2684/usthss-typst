...
#show: doc => conf(
  ...
  abstractCN: [本文介绍了 ustcthss-typst 文档模板所提供的功能. #lorem(100)],
  keywordsCN: ("Typst", "模板"),
  abstractEN: "This document introduces the features of the ustcthss-typst template.",
  keywordsEN: ("Typst", "Template"),
